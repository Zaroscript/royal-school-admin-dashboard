...
const Dashboard = () => {
  ...
  const recentActivities = [
    ...
    {
      id: 2,
      action: "تم تحديث جدول الامتحانات",
      user: "سارة أحمد",
      time: "منذ ساعة",
      type: "info",
      icon: Calendar,
    ...
    {
      id: 4,
      action: "تم إضافة مادة دراسية جديدة",
      user: "فاطمة علي",
      time: "منذ 5 ساعات",
      type: "warning",
      icon: BookOpen,
  ...
  const notifications = [
    ...
    },
    {
      ...
      message: "تم استلام دفعة مالية بقيمة 5000 ريال",
      time: "منذ ساعة",
      type: "success",
      read: false,
    },
    {
      id: 3,
      title: "تقرير الحضور",
      message: "تقرير الحضور الشهري جاهز للتحميل",
      time: "منذ 3 ساعات",
      type: "warning",
      read: true,
    },
    {
      id: 4,
      title: "صيانة النظام",
      message: "سيتم إجراء صيانة للنظام غداً من 2-4 صباحاً",
      time: "منذ 5 ساعات",
      type: "info",
      read: true,
    },
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div
        className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 p-8 rounded-2xl text-white 
      relative overflow-hidden animate-slide-in-bottom"
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="hidden lg:flex items-center space-x-4 space-x-reverse">
              ...
              <div
                className="p-4 rounded-full bg-white/10 backdrop-blur-sm animate-float"
          ...
          return (
            ...
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <div
                  className={`p-3 rounded-xl bg-gradient-to-br ${stat.gradient} hover-rotate`}
                >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 md:gap-6 px-1">
                ...
                <div className="flex flex-col space-y-2 md:space-y-4 min-w-[320px]">
                  {recentActivities.map((activity, index) => {
                    ...
                    return (
                      <div
                        key={activity.id}
                        className="flex items-start space-x-3 space-x-reverse p-3 rounded-lg hover:bg-muted/50 
                        transition-all duration-300 animate-slide-in-left hover-lift"
                        style={{ animationDelay: `${index * 0.1}s` }}
                      >
                        <div
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-foreground hover-scale">
                            {activity.action}
                          </p>
                          <p className="text-xs text-muted-foreground">
                            {activity.user}
                ...
                <div className="flex flex-col space-y-2 md:space-y-4 min-w-[320px]">
                  {upcomingEvents.map((event, index) => {
                    ...
                    return (
                      <div
                        key={event.id}
                        className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-muted/30 
                        to-muted/10 hover:from-muted/50 hover:to-muted/20 transition-all duration-300 
              ...
              <div className="flex flex-col space-y-2 md:space-y-4 min-w-[320px]">
                {financialOverview.map((month, index) => (
                  <div
                    ...
                    transition-all duration-300 animate-slide-in-right hover-lift"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <div className="flex items-center space-x-3 space-x-reverse">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          صافي الربح: {month.profit.toLocaleString()} ريال
                        </p>
                      </div>
                    </div>
      ...
      {/* Right Column - Sidebar */}
        <div className="space-y-6 grid grid-cols-1 xl:grid-cols-2 order-2 xl:order-1">
          ...
          <div>
            <div className="flex sm:hidden overflow-x-auto gap-3 pb-2 -mx-2 px-2">
              {attendanceTrends.map((day, index) => (
                <div
                  key={day.day}
                  className="min-w-[110px] max-w-[120px] flex-shrink-0 text-center space-y-2 bg-muted/40 rounded-xl
                  p-3 animate-slide-in-bottom shadow-sm"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                      ...
                      <div
                        ...
                        style={{
                          clipPath: `polygon(50% 50%, 50% 0%, ${
                            50 + day.attendance * 0.36
                          }% 0%, ${50 + day.attendance * 0.36}% 50%)`,
                        }}
                      ></div>
                    )}
                  </div>
            ...
            <div className="hidden sm:grid grid-cols-7 gap-4">
              {attendanceTrends.map((day, index) => (
                <div
                  key={day.day}
                  className="text-center space-y-2 animate-slide-in-bottom"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <p className="text-sm font-medium">{day.day}</p>
        ...
        <CardContent className="px-2 py-2 md:px-6 md:py-4">
          <Tabs defaultValue="overview" className="w-full">
            <TabsList className="grid w-full grid-cols-4">
              <TabsTrigger value="attendance" className="hover-glow">
                الحضور
              </TabsTrigger>
              <TabsTrigger value="financial" className="hover-glow">
                مالي
              </TabsTrigger>
              <TabsTrigger value="academic" className="hover-glow">
                أكاديمي
              </TabsTrigger>
            ...
            <TabsContent value="overview" className="space-y-4 mt-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div
                  className="p-4 rounded-lg bg-gradient-to-br from-red-500/10 to-red-500/5 border 
                border-red-500/20"
                >
                ...
                <div
                  className="p-4 rounded-lg bg-gradient-to-br from-blue-500/10 to-blue-500/5 border 
                border-blue-500/20"
                >
                  <div className="flex items-center justify-end space-x-2 space-x-reverse mb-2">
                ...
                <div
                  className="p-4 rounded-lg bg-gradient-to-br from-green-500/10 to-green-500/5 border 
                border-green-500/20"
                >
                  <div className="flex items-center justify-end space-x-2 space-x-reverse mb-2">
                ...
                {financialOverview.slice(0, 4).map((month, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-muted-foreground">
                        صافي: {month.profit.toLocaleString()}
                      </p>
                    </div>
                  </div>
                ))}
                ...
                <div>
                  <div className="flex sm:hidden overflow-x-auto gap-2 pb-2 -mx-2 px-2">
                    {attendanceTrends.map((day, index) => (
                      <div
                        key={day.day}
                        className="min-w-[90px] max-w-[100px] flex-shrink-0 text-center p-2 rounded-lg bg-muted/30 
                        animate-slide-in-bottom shadow-sm"
                        style={{ animationDelay: `${index * 0.1}s` }}
                      >
                  ...
                  <div className="hidden sm:grid grid-cols-7 gap-2">
                    {attendanceTrends.map((day, index) => (
                      <div
                        key={day.day}
                        className="text-center p-2 rounded-lg bg-muted/30 animate-slide-in-bottom"
                        style={{ animationDelay: `${index * 0.1}s` }}
                      >
                        <p className="text-xs font-medium">{day.day}</p>
                        <p className="text-lg font-bold text-green-500">
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-bold text-foreground animate-slide-in-bottom">
        ...
        <Card className="card-hover animate-slide-in-bottom stagger-15">
          <CardHeader className="px-2 py-2 md:px-6 md:py-4">
            ...
            <CardDescription>
              تطور متوسط الدرجات خلال الأسابيع الستة الماضية
            </CardDescription>
          </CardHeader>
          <CardContent className="px-2 py-2 md:px-6 md:py-4">
            <UiLineChart
        ...
        <Card className="card-hover animate-slide-in-bottom stagger-16">
          <CardHeader className="px-2 py-2 md:px-6 md:py-4">
            ...
            <CardDescription>
              الإيرادات والمصروفات خلال الأشهر الستة الماضية
            </CardDescription>
          </CardHeader>
          <CardContent className="px-2 py-2 md:px-6 md:py-4">
            <UiAreaChart
        ...
        <Card className="card-hover animate-slide-in-bottom stagger-17">
          <CardHeader className="px-2 py-2 md:px-6 md:py-4">
            ...
            <CardDescription>
              متوسط الدرجات وعدد الطلاب لكل مادة دراسية
            </CardDescription>
          </CardHeader>
          <CardContent className="px-2 py-2 md:px-6 md:py-4">
            <UiBarChart
          ...
          <CardContent className="px-2 py-2 md:px-6 md:py-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
              {studentDistributionData.map((item, index) => (
                <div
                  key={item.name}
                  className="flex items-center space-x-2 space-x-reverse p-2 rounded-lg bg-muted/30"
                >
                  <div
        ...
        <Card className="card-hover animate-slide-in-bottom stagger-19">
          <CardHeader className="px-2 py-2 md:px-6 md:py-4">
            ...
            <CardDescription>
              معدل الحضور والغياب خلال الأشهر الستة الماضية
            </CardDescription>
          </CardHeader>
          <CardContent className="px-2 py-2 md:px-6 md:py-4">
            <UiAreaChart
